...
CREATE TABLE `animais` (
  `CodAnimal` int(20) NOT NULL,
  `Numerobrinco` int(3) NOT NULL,
  `Corpelagem` varchar(40) NOT NULL,
  ...
  CONSTRAINT `animais_ibfk_1` FOREIGN KEY (`Inscricaoestadual`) REFERENCES `fazenda` (`Inscricaoestadual`)
